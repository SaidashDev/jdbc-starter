...
/*
 * Открытие соединения с базой данных через метод open()
 */
...
public final class ConnectionManager {
    ...
    //Для закрытия пула, потому что при вызове close() срабатывает через Proxy
    ...
    private static void initConnectionPool() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            //Вместо того, чтобы закрывать соединение, будем возвращать его в pool
            //реализовани через Proxy
